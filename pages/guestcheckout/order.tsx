...
const Order = () => {
    ...
    const { guestAddress } = useTypedSelector((state: AppState) => state.guest);
        ...
        <Section>
            ...
            <Margin>
                ...
                <Deliver>
                    <Row>
                        <h6>Receiver: </h6>
                        <h6>{guestAddress.fullname}</h6>
                    </Row>
                    <Row>
                        <h6>Street: </h6>
                        <h6>{guestAddress.street}</h6>
                    </Row>
                    <Row>
                        <h6>Code: </h6>
                        <h6>{guestAddress.postcode}</h6>
                    </Row>
                    <Row>
                        <h6>City: </h6>
                        <h6>{guestAddress.city}</h6>
                    </Row>
                    <Row>
                        <h6>Country: </h6>
                        <h6>{guestAddress.country}</h6>
                    </Row>
                </Deliver>
                <div>Total due</div>
