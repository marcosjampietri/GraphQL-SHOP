...
import { navOnAction, navOffAction } from "../../store/toggle/toggleActions";

const Burger = () => {
    const dispatch = useDispatch();

    const { NavOn } = useTypedSelector((state: AppState) => state.tog);
...
const Box = styled(animated.div)`
    ...
    border: 1px inset hsla(340, 80%, 0%, 1);
    border-radius: 5px;
    cursor: pointer;
